...
class DropTableStatementTest extends TestCase
{
    ...
    {
        // Test simple query.
        $expected_a = 'DROP TABLE useless_table';
        $actual_a = (string) new DropTableStatement('useless_table');
        $this->assertSame($expected_a, $actual_a);

        // Test skipping inexistent tables.
        $expected_b = 'DROP TABLE IF EXISTS useless_table';
        $actual_b = (string) new DropTableStatement('useless_table', true);
    }
}